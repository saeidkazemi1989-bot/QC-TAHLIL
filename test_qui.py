...
_BY_TITLE = {
    "اطلاعات جامع کیفیت حین تولید:": str(_REPO_ROOT / "data" / "raw" / "اطلاعات جامع کیفیت حین تولید (9).xlsx"),
    "گزارش عیب های سند بازرسی:": str(_REPO_ROOT / "data" / "raw" / "گزارش عیب های سند بازرسی (8).xlsx"),
    "گزارش تعداد تولید به تفکیک سند عملکرد:": str(_REPO_ROOT / "data" / "raw" / "گزارش تعداد تولید به تفکیک سند عملکرد (2).xlsx"),
    "گروه بندی محصولات:": str(_REPO_ROOT / "data" / "raw" / "گروه بندی محصولات.xlsx"),
