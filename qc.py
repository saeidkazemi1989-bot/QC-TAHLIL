...
SHEETS = [
    ...
    # -------------------------------------------------------------- پلیمر
    # کالاهای پلیمری (کد 130*) تنها در ایستگاه/مرکز کاری «بسته بندی» ثبت
    # می‌شوند و در هیچ‌کدام از شیت‌های بالا جایی ندارند؛ برای اینکه این
    # محصولات از گزارش جا نمانند، شیت مستقل «پلیمر» ساخته می‌شود:
    #   - ردیف‌های عیب:   از سند بازرسی (مانند دیگر شیت‌های بازرسی)
    #   - ردیف‌های تولید: مرکز کاری «بسته بندی»
    dict(
        name="پلیمر",
        defect_source="defect",
        code_prefix=("130",),
        ...
        station="بسته بندی",
        prod_prefix=("130",),
        prod_centers={"بسته بندی"},
        defect_decl="-",
        prod_shift="-",
        branch_const="POL",        # برنچ کالاهای پلیمری ثابت است
        prod_requires_grouping=False,   # کدهای 130 در جدول گروه‌بندی نیستند
    ),
]
# ---------------------------------------------------------------------------
# ابزارها
