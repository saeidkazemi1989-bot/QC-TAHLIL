...
SELECT i.*,
       ...
       COALESCE(p.unified_name, p.product_combined, p.product_name, i.product_code) AS unified_name,
       COALESCE(p.category, 'سایر')       AS category,
       COALESCE(p.stage, 'سایر')          AS stage,
       s.process_domain,
...
SELECT f.*,
       ...
       COALESCE(p.unified_name, p.product_combined, p.product_name, f.product_name) AS unified_name,
       COALESCE(p.category, 'سایر')       AS category,
       COALESCE(p.stage, 'سایر')          AS stage,
...
SELECT o.*,
       ...
       COALESCE(p.unified_name, p.product_combined, p.product_name, o.product_code) AS unified_name,
       COALESCE(p.category, 'سایر')       AS category,
       COALESCE(p.stage, 'سایر')          AS stage,
